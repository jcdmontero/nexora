...
export default function CajaIndex({ sesionActiva, cajasDisponibles, movimientos = { data: [], current_page: 1, last_page: 1 }, historial }) {
  ...
  return (
    <AuthenticatedLayout>
      ...
      {sesionActiva && movimientos.data.length > 0 && (
        <div className="mt-6">
          <Card className="shadow-sm border-border">
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-base font-semibold">Movimientos del Turno (Página {movimientos.current_page})</CardTitle>
                  <CardDescription>
